...
TX_BYTES = 64*16*2 + 16*8*2

@kernel(
    in_specs=(Tile.wgmma_a(64, 32, bf16), Tile.wgmma_b(32, 8, bf16)),
    out_specs=(Tile(64, 8, f32),),
    grid=(1, 1, 1), block=(128, 1, 1), arch="sm_90a",
)
def gemm_k_loop(A, B, C):
    ...
    for k_off in (0, 16):
        ...
        ptx.wgmma.mma_async(
            ...
            d=acc, a=sA, b=sB,
            scale_d=(k_off != 0), trans_a=0, trans_b=1,
        )
