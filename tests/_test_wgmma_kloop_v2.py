"""K-loop wgmma with explicit bar.sync between iterations."""
...
def gemm(A, B, C):
    ...
    # Explicit CTA sync between wgmma and next TMA.
    # This ensures all threads have passed wgmma.wait_group BEFORE
    # thread 0 starts rearming bar1 and issuing new TMA loads.
    ptx.bar.sync(0)
