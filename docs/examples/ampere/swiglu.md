...
[:material-github: View on GitHub](https://github.com/patrick-toulme/pyptx/blob/dev/examples/ampere/swiglu.py){ .md-button } 
[:material-file-code: `examples/ampere/swiglu.py`](https://github.com/patrick-toulme/pyptx/blob/dev/examples/ampere/swiglu.py){ .md-button }
