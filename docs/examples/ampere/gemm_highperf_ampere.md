# Ampere / Gemm Highperf Ampere

[:material-github: View on GitHub](https://github.com/patrick-toulme/pyptx/blob/dev/examples/ampere/gemm_highperf_ampere.py){ .md-button } 
[:material-file-code: `examples/ampere/gemm_highperf_ampere.py`](https://github.com/patrick-toulme/pyptx/blob/dev/examples/ampere/gemm_highperf_ampere.py){ .md-button }
