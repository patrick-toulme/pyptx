...
[:material-github: View on GitHub](https://github.com/patrick-toulme/pyptx/blob/dev/examples/ampere/softmax.py){ .md-button } 
[:material-file-code: `examples/ampere/softmax.py`](https://github.com/patrick-toulme/pyptx/blob/dev/examples/ampere/softmax.py){ .md-button }
