...
[:material-github: View on GitHub](https://github.com/patrick-toulme/pyptx/blob/dev/examples/ampere/rms_norm.py){ .md-button } 
[:material-file-code: `examples/ampere/rms_norm.py`](https://github.com/patrick-toulme/pyptx/blob/dev/examples/ampere/rms_norm.py){ .md-button }
