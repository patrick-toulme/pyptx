...
[:material-github: View on GitHub](https://github.com/patrick-toulme/pyptx/blob/dev/examples/hopper/grouped_gemm.py){ .md-button } 
[:material-file-code: `examples/hopper/grouped_gemm.py`](https://github.com/patrick-toulme/pyptx/blob/dev/examples/hopper/grouped_gemm.py){ .md-button }
