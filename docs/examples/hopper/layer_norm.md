...
[:material-github: View on GitHub](https://github.com/patrick-toulme/pyptx/blob/dev/examples/hopper/layer_norm.py){ .md-button } 
[:material-file-code: `examples/hopper/layer_norm.py`](https://github.com/patrick-toulme/pyptx/blob/dev/examples/hopper/layer_norm.py){ .md-button }
