...
[:material-github: View on GitHub](https://github.com/patrick-toulme/pyptx/blob/dev/examples/hopper/flash_norm.py){ .md-button } 
[:material-file-code: `examples/hopper/flash_norm.py`](https://github.com/patrick-toulme/pyptx/blob/dev/examples/hopper/flash_norm.py){ .md-button }
