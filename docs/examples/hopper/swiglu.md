...
[:material-github: View on GitHub](https://github.com/patrick-toulme/pyptx/blob/dev/examples/hopper/swiglu.py){ .md-button } 
[:material-file-code: `examples/hopper/swiglu.py`](https://github.com/patrick-toulme/pyptx/blob/dev/examples/hopper/swiglu.py){ .md-button }
