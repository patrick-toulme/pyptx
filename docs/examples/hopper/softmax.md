...
[:material-github: View on GitHub](https://github.com/patrick-toulme/pyptx/blob/dev/examples/hopper/softmax.py){ .md-button } 
[:material-file-code: `examples/hopper/softmax.py`](https://github.com/patrick-toulme/pyptx/blob/dev/examples/hopper/softmax.py){ .md-button }
