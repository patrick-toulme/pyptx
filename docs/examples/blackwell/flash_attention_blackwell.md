# Blackwell / Flash Attention Blackwell

[:material-github: View on GitHub](https://github.com/patrick-toulme/pyptx/blob/dev/examples/blackwell/flash_attention_blackwell.py){ .md-button } 
[:material-file-code: `examples/blackwell/flash_attention_blackwell.py`](https://github.com/patrick-toulme/pyptx/blob/dev/examples/blackwell/flash_attention_blackwell.py){ .md-button }
