...
[:material-github: View on GitHub](https://github.com/patrick-toulme/pyptx/blob/dev/examples/blackwell/tcgen05_smoke.py){ .md-button } 
[:material-file-code: `examples/blackwell/tcgen05_smoke.py`](https://github.com/patrick-toulme/pyptx/blob/dev/examples/blackwell/tcgen05_smoke.py){ .md-button }
