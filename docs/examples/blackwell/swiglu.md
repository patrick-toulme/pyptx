...
[:material-github: View on GitHub](https://github.com/patrick-toulme/pyptx/blob/dev/examples/blackwell/swiglu.py){ .md-button } 
[:material-file-code: `examples/blackwell/swiglu.py`](https://github.com/patrick-toulme/pyptx/blob/dev/examples/blackwell/swiglu.py){ .md-button }
