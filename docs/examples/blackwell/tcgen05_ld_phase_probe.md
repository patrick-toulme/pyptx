...
[:material-github: View on GitHub](https://github.com/patrick-toulme/pyptx/blob/dev/examples/blackwell/tcgen05_ld_phase_probe.py){ .md-button } 
[:material-file-code: `examples/blackwell/tcgen05_ld_phase_probe.py`](https://github.com/patrick-toulme/pyptx/blob/dev/examples/blackwell/tcgen05_ld_phase_probe.py){ .md-button }
