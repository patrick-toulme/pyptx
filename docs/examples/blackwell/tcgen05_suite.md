# Blackwell / Tcgen05 Suite

[:material-github: View on GitHub](https://github.com/patrick-toulme/pyptx/blob/dev/examples/blackwell/tcgen05_suite.py){ .md-button } 
[:material-file-code: `examples/blackwell/tcgen05_suite.py`](https://github.com/patrick-toulme/pyptx/blob/dev/examples/blackwell/tcgen05_suite.py){ .md-button }
