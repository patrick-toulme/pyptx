...
[:material-github: View on GitHub](https://github.com/patrick-toulme/pyptx/blob/dev/examples/blackwell/rms_norm.py){ .md-button } 
[:material-file-code: `examples/blackwell/rms_norm.py`](https://github.com/patrick-toulme/pyptx/blob/dev/examples/blackwell/rms_norm.py){ .md-button }
...
??? example "Full source"
    ...
    # layout for `python examples/blackwell/rms_norm.py` from a checkout.
    try:
